...
describe('Login Test',() => {
    ...
    it('Pozitif Test', () => {
        ...
        //have.text kullanamayiz dom yapisini alir
    ...
    it('Negatif Test', () => {
        ...
        .should('include.text' , 'Try again please')

        cy.get('.validation-summary-errors > ul > li')
        .should('include.text' , 'Username or password is incorrect, please correct them and try again')
